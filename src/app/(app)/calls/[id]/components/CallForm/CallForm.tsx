import { useDeleteCallMe } from '@/api/queries/CallMe/mutations'
      ...
      <Button
        onClick={() =>
          updateCall(formik.values)
            .unwrap()
            .then(() => dispatch(showModal({ title: 'Success', description: 'Call info successfully updated' })))
        }
